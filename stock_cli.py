...
def main() -> None:
    ...
    if args.command in ("sync-hs300", "sync-hs300-range", "sync-hs300-meta", "meta", "show-offsets", "plan", "evolve", "linyuan-picks", "sync-fundamentals-history", "sync-industry") or args.command is None:
        run_cli(args, [], {})
        return
